<form class="form container <?php if (isset($errors)): echo 'form--invalid'; endif; ?>" action="sign-up.php"
    ...
    <div class="form__item <?php if (isset($errors['name'])): echo 'form__item--invalid'; endif; ?>">
        ...
        <input id="name" type="text" name="name"
               value="<?php if (isset($sign_up['name'])): echo strip_tags($sign_up['name']); endif; ?>"
    ...
    <div class="form__item <?php if (isset($errors['message'])): echo 'form__item--invalid'; endif; ?>">
        ...
        <textarea id="message" name="message"
                  placeholder="Напишите как с вами связаться"><?php if (isset($sign_up['message'])): echo strip_tags($sign_up['message']); endif; ?></textarea>
