<form class="form container form--add-lot <?php if(isset($errors)): echo 'form--invalid'; endif; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    <h2>Добавление лота</h2>
    <div class="form__container-two">
        <div class="form__item <?php if(isset($errors['lot-name'])): echo 'form__item--invalid'; endif; ?>">
            <label for="lot-name">Наименование <sup>*</sup></label>
            <input id="lot-name" type="text" name="lot-name" value="<?php if(isset($lot['lot-name'])): echo strip_tags($lot['lot-name']); endif; ?>" placeholder="Введите наименование лота">
    ...
    <div class="form__item form__item--wide <?php if(isset($errors['message'])): echo 'form__item--invalid'; endif; ?>">
        ...
        <textarea id="message" name="message" placeholder="Напишите описание лота"><?php if(isset($lot['message'])): echo strip_tags($lot['message']); endif; ?></textarea>
    ...
    <div class="form__container-three">
        <div class="form__item form__item--small <?php if(isset($errors['lot-rate'])): echo 'form__item--invalid'; endif; ?>">
            ...
            <input id="lot-rate" type="text" name="lot-rate" placeholder="0" value="<?php if(isset($lot['lot-rate'])): echo strip_tags($lot['lot-rate']); endif; ?>">
        ...
        <div class="form__item form__item--small <?php if(isset($errors['lot-step'])): echo 'form__item--invalid'; endif; ?>">
            ...
            <input id="lot-step" type="text" name="lot-step" placeholder="0" value="<?php if(isset($lot['lot-step'])): echo strip_tags($lot['lot-step']); endif; ?>">
        ...
        <div class="form__item <?php if(isset($errors['lot-date'])): echo 'form__item--invalid'; endif; ?>">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="lot-date" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?php if(isset($lot['lot-date'])): echo strip_tags($lot['lot-date']); endif; ?>">
